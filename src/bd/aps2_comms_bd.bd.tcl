...
#  -string -flagsOSRD
preplace inst tcp_bridge_0 -pg 1 -lvl 1 -y 240 -defaultsOSRD
preplace inst eprom_cfg_reader_0 -pg 1 -lvl 2 -y 0 -defaultsOSRD
levelinfo -pg 1 -510 -360 -40 260 -top -160 -bot 430
",
}
