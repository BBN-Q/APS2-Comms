...
switch to the './tcp_demux_tb.sh' script.

./tcp_demux_tb.sh -reset_run
...
./tcp_demux_tb.sh -noclean_files

For more information on the script, please type './tcp_demux_tb.sh -help'.
