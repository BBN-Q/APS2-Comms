...
switch to the './tcp_bridge_tb.sh' script.

./tcp_bridge_tb.sh -reset_run
...
./tcp_bridge_tb.sh -noclean_files

For more information on the script, please type './tcp_bridge_tb.sh -help'.
